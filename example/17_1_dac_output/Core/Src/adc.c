...
void MX_ADC2_Init(void)
{
  ...
  */
  ...
  HAL_ADCEx_Calibration_Start(&hadc2);              /* Calibrating ADC */
...
* @retval 	None
*/
void adc2_channel_set(ADC_HandleTypeDef *adc_handle, uint32_t ch, uint32_t rank, uint32_t stime)
{
...
{
    adc2_channel_set(&hadc2 , ch, ADC_REGULAR_RANK_1, ADC_SAMPLETIME_239CYCLES_5);    /* Set the channel, sequence, and sampling time */
