...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  ...
	  lcd_show_xnum(30 + 11 * 8, 120, temp / 100, 2, 16, 0, BLUE);    /* Display integer part */
	  lcd_show_xnum(30 + 14 * 8, 120, temp % 100, 2, 16, 0X80, BLUE); /* Display integer part */

	  LED0_TOGGLE();												  /* LED state is flipped */
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
}
